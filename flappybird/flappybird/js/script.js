$(function () {
    ...
    $('#container').mousedown(function (e) {
        go_up = setInterval(up, 50); // Realtime hành động bay lên cho chú chim
    });
    ...
    $('#play_btn').click(function() {
      ...
      // Sử dụng phím mũi tên để điều khiển chim
      $(document).keydown(function (e) {
        playGame();
        go_up = setInterval(up, 50); // Bắt đầu bay lên khi nhấn mũi tên lên
    });


    $(document).keyup(function (e) {
        clearInterval(go_up); // Ngừng bay lên khi thả phím mũi tên lên
        go_up = false;  
    });
